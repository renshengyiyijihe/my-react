(function (global, factory) {
	...
	(global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.client = {}, global.React));
	    ...
	    function updateFromMap(returnFiber, existingChildren, index, element) {
	        ...
	        if (typeof element === 'object' && element !== null) {
	            switch (element.$$typeof) {
	                ...
	                default:
	                    if (__DEV__) {
	                        console.warn('updateFromMap 未实现的react type类型 ->> ', element.$$typeof);
	                    }
	            }
	        }
	...
	function updateState() {
	    ...
	    const lane = requestUpdateLane();
	    if (pending !== null) {
	        const { memoizedState } = processUpdateQueue(hook.memoizedState, pending, lane);
	        hook.memoizedState = memoizedState;
	    }
	...
	const scheduleMicroTask = typeof queueMicrotask === 'function'
	    ...
	    : typeof Promise === 'function'
	        ? (cb) => Promise.resolve(null).then(cb)
	        : setTimeout;
